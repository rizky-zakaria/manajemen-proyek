                        ...
                        <nav>
                            <div class="nav nav-tabs" id="nav-tab" role="tablist">
                                ...
                                <button class="nav-link" id="nav-profile-tab" data-toggle="tab"
                                    data-target="#nav-tasklist" type="button" role="tab" aria-controls="nav-profile"
                                    aria-selected="false">Tasklist</button>
                                <button class="nav-link" id="nav-profile-tab" data-toggle="tab"
                                ...
                                {{-- <button class="nav-link" id="nav-profile-tab" data-toggle="tab"
                                    data-target="#nav-gantt" type="button" role="tab" aria-controls="nav-profile"
                                            ...
                                            <div class="timeline__items">
                                                ...
                                                <div class="timeline__item">
                                                    <div class="timeline__content">
                                                        <h2>{{ $item->tgl_mulai . ' ' . $bulan[$item->bln_mulai] . ' ' .
                                                            $item->thn_mulai }}
                                                            s/d
                                                            {{ $item->tgl_selesai . ' ' . $bulan[$item->bln_selesai] . '
                                                            ' . $item->thn_selesai }}
                                                        </h2>
                                                        <p>{{ $item->task_name }}</p>
                                                    </div>
                                        ...
                                        <table class="table table-striped" id="table-1">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        {{ $item->tgl_mulai . ' ' . $bulan[$item->bln_mulai] . ' ' .
                                                        $item->thn_mulai }}
                                                    </td>
                                                    <td>
                                                        {{ $item->tgl_selesai . ' ' . $bulan[$item->bln_selesai] . ' ' .
                                            ...
                                            <div class="card-body">
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <input type="text" name="nama_proyek" class="form-control float-right @error('nama_proyek')
                                                                is-invalid
                                                            @enderror" value="{{ $data->nama_proyek }}"
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <input type="text" name="anggaran" class="form-control float-right @error('anggaran')
                                                                is-invalid
                                                            @enderror" value="{{ $data->anggaran }}" id="reservation"
                                                            disabled>
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <input type="text" name="lokasi" value="{{ $data->lokasi }}"
                                                            class="form-control float-right @error('lokasi')
                                                                is-invalid
                                                            @enderror" id="reservation" disabled>
                                                    </div>
                                                </div>
                                                <div class="form-row">
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="input-group">
                                                                ...
                                                                <input type="text" name="waktu_mulai" class="form-control float-right @error('waktu_mulai')
                                                                        is-invalid
                                                                    @enderror" value="{{ $data->waktu_mulai }}"
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="input-group">
                                                                ...
                                                                <input type="text" name="waktu_selesai" class="form-control float-right @error('waktu_selesai')
                                                                        is-invalid
                                                                    @enderror" value="{{ $data->waktu_selesai }}"
                                                                    id="reservationtime" disabled>
                                                            </div>
                                                        </div>
                                                    </div>

                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <input type="text" name="nama_proyek"
                                                            class="form-control float-right @error('nama_proyek')
                                                                is-invalid
                                                            @enderror"
                                                            value="{{ $data->nama_proyek }}" id="reservation" required>
                                                        @error('nama_proyek')
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <input type="number" name="anggaran"
                                                            class="form-control float-right @error('anggaran')
                                                                is-invalid
                                                            @enderror"
                                                            value="{{ $data->anggaran }}" id="reservation" required>
                                                        @error('anggaran')
                                                            <span class="text-sm text-danger">{{ $message }}</span>
                                                        @enderror
                                                    </div>
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <input type="text" name="lokasi"
                                                            class="form-control float-right @error('lokasi')
                                                                is-invalid
                                                            @enderror"
                                                            value="{{ $data->lokasi }}" id="reservation" required>
                                                        @error('lokasi')
                                                            <span class="text-sm text-danger">{{ $message }}</span>
                                                        @enderror
                                                    </div>
                                                            ...
                                                            <div class="input-group is-invalid">
                                                                <div class="custom-file">
                                                                    ...
                                                                    <input type="file" class="custom-file-input"
                                                                        ...
                                                                        value="{{ asset('uploads/files/' . $data->file) }}"
                                                                        required>
                                                                </div>
                                                            </div>
                                                        </div>
